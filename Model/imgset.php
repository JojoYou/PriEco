...
echo '
 ...
 <input class="imgSave imgtoolsOption"type="submit" name="imgtoolsSave" value="Save">

 </form>
 <form method="post">
 <input class="imgPixa imgtoolsOption" type="submit" name="pixabayimg" value="Pixabay">
 </form>
 </div>';
