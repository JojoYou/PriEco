<?php
 if (preg_match('/\bip\b/i', $purl) && !str_starts_with($_SERVER['REMOTE_ADDR'], '192.') && !str_starts_with($_SERVER['REMOTE_ADDR'], '127.')) {
    echo '<div class="redditCon output">
      <p class="borderBottom centerTxt">Your Public IP Address is: <b>',(isset($_SERVER['HTTP_CF_CONNECTING_IP']) ? $_SERVER['HTTP_CF_CONNECTING_IP'] : $_SERVER['REMOTE_ADDR']),'</b></p><br>
